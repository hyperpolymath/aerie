...
@cli.callback() # This is the main callback for the Typer app itself
def main_callback() -> None:
    """Manage hyperglass application."""
    # This main_callback function is run for every command.
    pass

def run():
    """Run the hyperglass CLI."""
    # This will now correctly execute the cli.
