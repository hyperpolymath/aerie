...
#
# Estate architecture law: ABI = Idris2 (src/abi/), FFI + API = Zig.
#   The V implementation (src/api/v/) was removed under the estate-wide
#   V ban (deprecated 2026-04-12, removed 2026-05-16). The canonical
