...
#
# ============================================================================
# aerie-launcher.sh — Aerie
# ============================================================================
# GENERATED by launch-scaffolder from aerie.launcher.a2ml.
...
APP_NAME="aerie"
APP_DISPLAY="Aerie"
APP_DESC="Aerie Network Diagnostic Suite"
APP_CATEGORIES="Network;System;Utility;"
APP_GENERIC_NAME="Aerie"
RUNTIME_KIND="process"

REPO_DIR="/var/mnt/eclipse/repos/aerie"
ICON_SOURCE="/var/mnt/eclipse/repos/aerie/assets/icon-256.png"
...
CONFIG_FILE="/var/mnt/eclipse/repos/aerie/aerie.launcher.a2ml"
...
START_COMMAND=(/home/hyper/Desktop/Repo-Projects/launchers/repo-quicklaunch.sh /var/mnt/eclipse/repos/aerie Aerie just tour )
...
[runtime].startup-command-search or [runtime].command in aerie.launcher.a2ml."
            return 1
        fi
    fi
